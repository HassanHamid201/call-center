...
export default function FaqPage() {
  ...
  if (isLoading) return <div className="p-8 text-center">Loading FAQ...</div>
      ...
      <div className="flex flex-col sm:flex-row sm:items-center sm:justify-between gap-4">
        ...
        <div className="relative">
          ...
          <input
            ...
            className="pl-9 pr-4 py-2 border border-gray-300 rounded-md text-sm focus:ring-primary-500 focus:border-primary-500 w-64"
          />
        </div>
      </div>
          ...
          {data?.items.map((item) => (
            <li key={item.id}>
              <button
                ...
                className="w-full text-left px-4 py-4 sm:px-6 hover:bg-gray-50 focus:outline-none"
              >
