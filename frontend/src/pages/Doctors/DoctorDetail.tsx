...
export default function DoctorDetail() {
  ...
  if (!doctor) return <div className="p-8 text-center">{t('doctors.notFound')}</div>
      ...
      <div className="card">
        <div className="flex items-center justify-between flex-wrap gap-2">
          <div className="flex items-center">
            <Stethoscope className="h-8 w-8 text-primary-600 me-3" />
            <div>
          ...
          <div className="flex gap-2">
            {doctor.classification && (
              <span className="inline-flex items-center px-3 py-1 rounded-full text-sm font-medium bg-blue-100 text-blue-800">
                <BadgeCheck className="h-4 w-4 me-1" />
        ...
        <div className="mt-6 grid grid-cols-1 md:grid-cols-2 gap-4 text-sm">
          ...
          <div className="flex items-center text-gray-600">
            ...
            {doctor.languages?.join(', ') || t('common.none')}
          </div>
          <div className="flex items-center text-gray-600">
          ...
          {doctor.internalExtension && (
            <div className="flex items-center text-gray-600">
              <Phone className="h-4 w-4 me-2" />
              {t('doctors.ext', { ext: doctor.internalExtension })}
            </div>
          )}
          {doctor.nationality && (
            <div className="flex items-center text-gray-600">
        ...
        {doctor.clinicMechanism && (
          <div className="mt-6">
            <h3 className="text-sm font-medium text-gray-900 mb-2">{t('doctors.clinicMechanism')}</h3>
            <p className="text-sm text-gray-600 bg-gray-50 p-3 rounded">{tValue(doctor.clinicMechanism, 'clinicMechanism')}</p>
          </div>
        )}

        {doctor.services && (
          <div className="mt-6">
            <h3 className="text-sm font-medium text-gray-900 mb-2">{t('doctors.services')}</h3>
        ...
        {doctor.insuranceNotes && (
          <div className="mt-6">
            <h3 className="text-sm font-medium text-gray-900 mb-2">{t('doctors.insuranceNotes')}</h3>
        ...
        {doctor.notes && (
          <div className="mt-6">
            <h3 className="text-sm font-medium text-gray-900 mb-2">{t('doctors.notes')}</h3>
        ...
        {doctor.biography && (
          <div className="mt-6">
            <h3 className="text-sm font-medium text-gray-900 mb-2">{t('doctors.biography')}</h3>
