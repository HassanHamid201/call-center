        ...
        <div className="flex justify-between h-16">
          <div className="flex items-center">
            ...
            <a href="/" className="flex items-center ml-2 lg:ml-0">
              ...
              <span className="ml-2 text-sm text-gray-500 hidden sm:inline">Medical Group Portal</span>
            </a>
          </div>
          ...
          {isAuthenticated && user && (
            <div className="flex items-center space-x-4">
              <div className="hidden md:flex items-center text-sm text-gray-700">
                ...
                <span className="ml-2 px-2 py-0.5 rounded-full bg-primary-100 text-primary-700 text-xs">
                  {user.role}
                </span>
              </div>
              <button
